...
/*
 * Structure of a blocks group descriptor  これはなんのため？
 */
...
struct ext2_inode {
	...
	__u16	i_mode;		/* File mode: important */ 
	__u16	i_uid;		/* Owner Uid */
	__u32	i_size;		/* Size in bytes : important*/
	__u32	i_atime;	/* Access time */
	__u32	i_ctime;	/* Creation time */
	__u32	i_mtime;	/* Modification time */
	__u32	i_dtime;	/* Deletion Time */
	__u16	i_gid;		/* Group Id */
	__u16	i_links_count;	/* Links count : important*/
	__u32	i_blocks;	/* Blocks count */
	__u32	i_flags;	/* File flags */
	__u32 i_reserved1;

	__u32	i_block[EXT2_N_BLOCKS];/* Pointers to blocks : important EXT2_N_BLOCKS =12*/
